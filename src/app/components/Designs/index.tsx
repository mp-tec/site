...
export function Designs() {
    return (
        <div className='flex md:mt-5 md:pl-52 space-x-5 pl-4 overflow-x-auto pr-2 pb-2'>
            <Image src={CerroImg} quality={100} priority={true} alt="" className='h-96 rounded-sm w-[1000px]' />
            <Image src={System} width={600} height={600} alt="" className='h-96 rounded-sm w-[1000px]' />
